      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 font-medium">
            {isLogin ? 'Sign in to access your worksheets.' : 'Start generating zero-edit ESL materials.'}
          </p>
        </div>
          ...
          {!isLogin && (
            <div>
              ...
              <input 
                ...
                placeholder="Jake Mai"
                className="w-full border border-gray-200 p-3 rounded-xl focus:outline-none focus:border-black transition"
              />
            </div>
          )}
          <div>
        ...
        <div className="text-center text-sm font-medium text-gray-500 mb-6">
          ...
          <button type="button" onClick={() => setIsLogin(!isLogin)} className="text-black font-bold hover:underline">
