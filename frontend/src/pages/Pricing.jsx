...
export default function Pricing() {
  ...
  const en = {
    ...
    intro: 'Start free with three worksheets. Upgrade when you want more capacity and zero interruptions.',
    free_h: 'Free',
    free_sub: 'Three worksheets to start, then earn more with sponsor videos.',
    free_period: 'forever',
    premium_h: 'Premium',
    premium_sub: 'No ads. More room for regular teaching.',
    premium_period: '/ month',
    pro_h: 'Pro',
    pro_sub: 'Higher-capacity tools for heavier classroom use.',
    pro_period: '/ month',
    ...
    model_claude: 'AI: Premium model routing',
    no_ads: 'Zero ads',
  ...
  const vi = {
    ...
    intro: 'Bắt đầu miễn phí với ba bài tập. Nâng cấp khi cần thêm dung lượng và không muốn bị gián đoạn.',
    free_h: 'Miễn phí',
    free_sub: 'Ba bài tập khởi đầu, sau đó kiếm thêm qua video tài trợ.',
    free_period: 'vĩnh viễn',
    premium_h: 'Cao cấp',
    premium_sub: 'Không QC. Thêm dung lượng cho việc dạy thường xuyên.',
    premium_period: '/ tháng',
    pro_h: 'Pro',
    pro_sub: 'Công cụ dung lượng cao hơn cho nhu cầu lớp học nặng hơn.',
    pro_period: '/ tháng',
    most_popular: 'Phổ biến nhất',
    cta_free: 'Bắt đầu',
    cta_premium: 'Nâng cấp Cao cấp',
    cta_pro: 'Nâng cấp Pro',
    ...
    model_flash: 'AI: OpenRouter Free',
    model_pro: 'AI: OpenRouter Auto',
    model_claude: 'AI: định tuyến mô hình cao cấp',
